...
HD_PWD='D:/SoCLyThuyet/MatrixMult_pipeline/MatrixMult_pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MatrixMult4x4_pipeline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MatrixMult4x4_pipeline.tcl -notrace
