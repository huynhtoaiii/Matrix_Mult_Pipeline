...
HD_PWD='D:/SoCLyThuyet/MatrixMult_pipeline/MatrixMult_pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MatrixMult4x4_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MatrixMult4x4_pipeline.tcl
