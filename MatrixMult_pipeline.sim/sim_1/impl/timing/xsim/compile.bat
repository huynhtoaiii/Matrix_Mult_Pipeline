...
REM
REM Generated by Vivado on Sat May 02 19:37:13 +0700 2026
...
echo "xvlog --incr --relax -prj tb_MatrixMult4x4_pipeline_vlog.prj"
call xvlog  --incr --relax -prj tb_MatrixMult4x4_pipeline_vlog.prj -log xvlog.log
